function generateHTML(answers) {
    ...
    return `<!DOCTYPE html>
        ...
        <head>
            ...
            <style>
                .card-header {
                    background-color: rgb(159, 186, 248)
                }
    
                .card {
                    box-shadow: 5px 10px lightgray;
                    background-color: rgb(162, 235, 253)
                }
                            ...
                            <div class="col mb-4">
                                <div class="card border-dark mb-4" style="width: 19rem;">
                                    <div class="card-header">
                                        ...
                                        <h5><i class="fas fa-robot"></i>Engineer</h5>
                                    </div>
                                    <div class="card-body text-dark">
                                        <div class="card" style="width: 16rem;">
                                            <ul class="list-group list-group-flush">
                                    ...
                                    <div class="card-body text-dark">
                                        <div class="card" style="width: 16rem;">
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item" style="text-align:left"><strong>School: </strong>${answers.schoolIntern}
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
